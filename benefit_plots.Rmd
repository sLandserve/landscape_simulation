...
res <- out %>% 
  mutate(amt_scenario = case_when(p_supply == 0.1 & p_demand == 0.1 ~ "LowS_LowD",
                                  ...
                                  TRUE ~ "None"),
         service_scenario = case_when(beta == 0 & gamma == 1e-01 & rival == TRUE ~ "type1",
                                      beta == 0 & gamma == 1e-01 & rival == FALSE ~ "type2",
                                      beta == 0 & gamma == 1e-06 & rival == TRUE ~ "type3",
                                      beta == 0 & gamma == 1e-06 & rival == FALSE ~ "type4",
                                      beta == 0.01 & gamma == 1e-01 & rival == TRUE ~ "type5",
                                      beta == 0.01 & gamma == 1e-01 & rival == FALSE ~ "type6",
                                      beta == 0.01 & gamma == 1e-06 & rival == TRUE ~ "type7",
                                      beta == 0.01 & gamma == 1e-06 & rival == FALSE ~ "type8")) %>% 
