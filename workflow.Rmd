...
This also generates a discrete networks for the network analysis
...
Next step is to create the distance matrix, and a table which includes `ID`, `patch_type`, `patch_area` for each simulated landscape.
...
sourceDirectory("R")
network <- lapply(sim_ls[2], function(x,ee_link, ee_threshold, es_threshold) network_create(x, ee_link, ee_threshold, es_threshold), ee_link = ee_link, ee_threshold = ee_threshold, es_threshold = es_threshold)
