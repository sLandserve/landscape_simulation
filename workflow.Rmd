...
ls_df <- ldply(sim_ls, function(x) {
  ...
  filter(rep == 1 & (f_supply == 0.25 | f_supply == 0.5 | f_supply == 0.75) & (f_demand == 0.25 | f_demand == 0.5 | f_demand == 0.75)) %>%
...
net_first_rep <- lapply(network, function(x) if(x$params["rep"] == 1 & (x$params["f_supply"] == 0.25 | x$params["f_supply"] == 0.75) & (x$params["f_demand"] == 0.25 | x$params["f_demand"] == 0.75) & (x$params["inter"] == 0.25 | x$params["inter"] == 0.75)) {return(x)})

net_first_rep <- net_first_rep[-which(sapply(net_first_rep, is.null))]
