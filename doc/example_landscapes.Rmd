---
title: "Landscape Simulation: Initial thoughts"
author: "Laura Graham"
...
# setting the size of the generated landscapes
nrow = ncol = 50
```
...
```{r}
# roughness = 1 --> highest level of fragmentation (no spatial autocorrelation)
